...
const greetUser = username => {return console.log(`Welcome back, ${username}`)}
// greetUser('bebz')
// console.log(greetUser('Bebz'));
...
function canWeDeliver(zipCode) {
    for (let i = 0; i < deliveryAreaZipCodes.length; i++) {
        if (deliveryAreaZipCodes[i] === zipCode){
            console.log("Give us your money. You are within range.");
        }else if(deliveryAreaZipCodes[i] != zipCode){
            console.log("Sorry, we can't deliver to you, fool.");
        }
    }
}
